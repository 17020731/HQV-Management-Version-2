...
public class ManagementPayment {
    ...
    public void VangPayment(){
        ...
        if(TienMat.isSelected()){
            ...
            thanhtoan = "Tiền mặt";
        String his = a1+":"+a2+":"+a3+":"+a4+":"+a5+":"+a8+":"+a9+":"+a10+":"+a11+":"+a12+":"+a13+":"+a14+":"+thanhtoan+":"+ghichu;
        ...
        notifi.note(vangPane, "Giao dịch thành công!!","#56d366");
        KhachHang.setText("");
        TenSp.setText("");
        Type.setText("");
        DonGia.setText("");
...
//            stage.close();
    ...
    public void NgoaitePayment(){
        ...
        notifi.note(ngoaitePane, "Giao dịch thành công!!","#56d366");
        KhachHang1.setText("");
        LoaiTien.setText("");
        SoLuong1.setText("");
        DonGia1.setText("");
...
//            stage.close();
    ...
    public void KhacPayment(){
        ...
        notifi.note(otherPane, "Giao dịch thành công!!","#56d366");
...
//            stage.close();
    ...
    public void acceptPayment(){
        try {
            TongTien.setOnKeyPressed(new EventHandler<KeyEvent>() {
                @Override
            ...
            TongTien.setOnKeyReleased(new EventHandler<KeyEvent>() {
                ...
                public void handle(KeyEvent event) {
                    try {
                        ...
                        else if (TongTien.getText().trim().equals(""))
                                Tong.setText("");
                    }catch (NumberFormatException e){
                        System.out.println("Lỗi định dạng!!");
                        notifi.note(vangPane, "Vui lòng kiểm tra lại!!","#ee4c4c");
                    }
                }
            });
